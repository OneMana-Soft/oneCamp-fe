...
import {openUpdateChannelMemberDialog} from "@/store/slice/dialogSlice";
                ...
                <div className="flex flex-col flex-1 gap-6 p-6">
                    ...
                    <section>
                        ...
                        <div className="flex items-center ">
                            ...
                            <div className="rounded-full border h-10 w-10 flex justify-center items-center border-dashed" onClick={()=>{dispatch(openUpdateChannelMemberDialog({channelUUID: channelId}))}}>
