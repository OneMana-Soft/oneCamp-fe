...
import {openChannelFileUpload, openChatCommentFileUpload} from "@/store/slice/fileUploadSlice";
        ...
        post.makeRequest<CreateUpdateCommentReqInterface, CreateCommentResInterface>({
            ...
            .then((res)=>{
                ...
                if(res?.comment_id && selfProfile.data?.data) {
                    ...
                    dispatch(updateChatMessageReplyIncrement({messageId: chatMessageUUID, chatId: chatId, comment: {comment_text: "", comment_created_at: res?.comment_created_at, comment_uuid: res?.comment_id}}))
            ...
            <div ref={contentRef}> {/* Wrap all content in a ref */}
                <div ref={editorRef}>
                    <MinimalTiptapTextInput
                        attachmentOnclick={() => { dispatch(openChatCommentFileUpload()) }}
                        throttleDelay={300}
