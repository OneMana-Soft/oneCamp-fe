...
export const ReactionPicker = ({children, onReactionSelect, showCustomReactions}:ReactionPickerPopoverProps) => {
        ...
        <>
            {isMobile ?
               (<div onClick={onClick}>
                ...
                :
                (<ReactionPickerPopover onReactionSelect={onReactionSelect} showCustomReactions={showCustomReactions}>
                    {children}
